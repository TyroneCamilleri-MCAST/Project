...
ENABLE_RANDOM_BG_COLOR = True  # Change to False to disable random background colors
ALLY_OPACITY_MIN = 255  # Minimum opacity
ALLY_OPACITY_MAX = 255  # Maximum opacity
SHOW_BOUNDING_BOXES = True  # Set to False to hide bounding boxes
...
def main():
    ...
    while running:
        ...
        # Rotate the central icon if enabled
        if ENABLE_PLAYER_ROTATION:
            ...
            current_rotation_frame = (current_rotation_frame + 1) % ROTATION_NUMBER_OF_FRAMES
        else:
