...
SHOW_ENEMIES = False  # Set to False to hide enemies
SHOW_ALLIES = False  # Set to False to hide allies
LABEL_ENEMIES = False  # Set to False to disable labeling of enemies
LABEL_ALLIES = False  # Set to False to disable labeling of allies
LABEL_PLAYER = False  # Set to False to disable labeling of the player

# Counters for enemies and allies
enemy_spawn_count = 0
ally_spawn_count = 0
...
def main():
    global enemy_spawn_count, ally_spawn_count
    ...
    while running:
        ...
        # Check if either count has reached 20,000
        if enemy_spawn_count >= 20000 and ally_spawn_count >= 20000:
            pygame.quit()
            sys.exit()

        # Generate a random background color
        random_background_color = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
        screen.fill(random_background_color)
