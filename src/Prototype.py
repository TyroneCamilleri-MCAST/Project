...
objectDetectionModel = YOLO(r"./Models/object_detection/MainModel2/weights/best.pt")
classificationModel = YOLO(r"./Models/classification/MainModel/weights/best.pt")

cap = cv2.VideoCapture(r"./assets/videos/2024-05-27 15-20-32.mp4")

output_dir = r"./cropped-players"
    ...
    if not paused:
        ...
        if success:
            ...
            if player_boxes:
                ...
                player_crop_path = os.path.join(output_dir, f"player_crop_{frame_count}.jpg")
